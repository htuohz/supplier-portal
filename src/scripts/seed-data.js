...
const mockSuppliers = [
  {
    ...
    description:
      "Leading manufacturer of consumer electronics with over 15 years of experience.",
  ...
  },
  {
    ...
    description:
      "Premium textile manufacturer with state-of-the-art facilities.",
  ...
  // 添加更多供应商数据...
  {
    ...
    description:
      "Specialized in automotive components with advanced production lines.",
